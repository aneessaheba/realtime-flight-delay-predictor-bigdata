...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--batch-path", default="hdfs://namenode:9000/output/batch_predictions")
    parser.add_argument("--streaming-path", default="hdfs://namenode:9000/output/streaming_predictions")
