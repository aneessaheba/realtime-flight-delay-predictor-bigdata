...
io.delta:delta-core_2.12:2.4.0 \
  ...
  --model   hdfs://hdfs-namenode:9000/models/gbt_pipeline \
  --kafka   kafka:9092 \
  --topic   flight-events \
  --output  hdfs://hdfs-namenode:9000/output/streaming_predictions \
  --trigger 5
"""
...
def main():
    ...
    parser.add_argument("--model",   default="hdfs://hdfs-namenode:9000/models/gbt_pipeline")
